...
当前实现中，`POST /internal/auth/tenants`、`POST /internal/auth/tenants/{id}/disable`、`POST /internal/auth/tenants/{id}/enable`、`POST /internal/auth/tenants/{id}/initialize-admin`、`POST /internal/auth/tenants/{id}/set-plan`、`POST /internal/auth/users/register`、`POST /internal/auth/tenant-members/invite`、`POST /internal/auth/tenant-members/confirm-invitation`、`POST /internal/auth/tenant-members/{id}/disable`、`POST /internal/auth/tenant-members/{id}/enable` 与 `GET /internal/auth/me/tenants` 都返回 `business_code + business_detail_code`。
